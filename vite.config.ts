...
export default defineConfig(({ command, mode }) => {
  ...
  return {
    ...
    define: {
      ...
      "import.meta.env.ENFORCE_YOUTUBE_COMPLIANCE": JSON.stringify(
        env.ENFORCE_YOUTUBE_COMPLIANCE,
      ),
      ...
      "import.meta.env.GITHUB_ISSUE_URL": JSON.stringify(
        env._P_GITHUB_ISSUE_URL,
      ),
      "import.meta.env.ROUTE_PREFIX": JSON.stringify(env.ROUTE_PREFIX),
      "import.meta.env.TIMEZONE_DIFF_IN_HOUR": JSON.stringify(
        env.TIMEZONE_DIFF_IN_HOUR,
      ),
